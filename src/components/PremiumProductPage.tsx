    ...
    <div className="relative h-full w-full overflow-hidden bg-background">
      ...
      <div className="relative z-10 flex flex-col h-full pt-16 pb-32">
        ...
        <div className="px-4 py-4">
          <p className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-pink-500 to-rose-500 bg-clip-text text-transparent">
            {formatPrice(car.price)}
          </p>
          {car.originalPrice && (
            <p className="text-sm text-white/60 line-through">
              <span className="text-rose-400">-{Math.round((1 - car.price/car.originalPrice)*100)}%</span> {formatPrice(car.originalPrice)}
            </p>
          )}
        </div>
        ...
        <div className="px-4 py-3">
          <div className="grid grid-cols-3 gap-3">
            <div className="flex flex-col items-center justify-center p-3 bg-white/10 backdrop-blur-md rounded-xl">
              <Gauge className="h-5 w-5 text-white mb-1" />
              <span className="text-xs text-white/80">Kilométrage</span>
              <span className="text-sm font-medium text-white">{formatMileage(car.mileage)}</span>
            </div>
            <div className="flex flex-col items-center justify-center p-3 bg-white/10 backdrop-blur-md rounded-xl">
              <Fuel className="h-5 w-5 text-white mb-1" />
              <span className="text-xs text-white/80">Carburant</span>
              <span className="text-sm font-medium text-white capitalize">{car.fuelType}</span>
            </div>
            <div className="flex flex-col items-center justify-center p-3 bg-white/10 backdrop-blur-md rounded-xl">
